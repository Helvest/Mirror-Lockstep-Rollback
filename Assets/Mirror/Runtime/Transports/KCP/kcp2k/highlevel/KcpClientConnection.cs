...
namespace kcp2k
{
	public class KcpClientConnection : KcpConnection
	{
		...
		private void ConfigureSocketBufferSizes(bool maximizeSendReceiveBuffersToOSLimit)
		{
			...
			{
				Log.Info($"KcpClient: RecvBuf = {socket.ReceiveBufferSize} SendBuf = {socket.SendBufferSize}. If connections drop under heavy load, enable {nameof(maximizeSendReceiveBuffersToOSLimit)} to increase it to OS limit. If they still drop, increase the OS limit.");
			}
		}
