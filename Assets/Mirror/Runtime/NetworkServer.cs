...
namespace Mirror
{
	...
	public static class NetworkServer
	{
		...
		internal static void OnTransportData(int connectionId, ArraySegment<byte> data, int channelId)
		{
			if (connections.TryGetValue(connectionId, out var connection))
			{
				...
				while (!isLoadingScene &&
					   connection.unbatcher.GetNextMessage(out var reader, out double remoteTimestamp))
				{
		...
		// spawning ////////////////////////////////////////////////////////////
		public static ArraySegment<byte> CreateSpawnMessagePayload(bool isOwner, NetworkIdentity identity, PooledNetworkWriter ownerWriter, PooledNetworkWriter observersWriter)
		{
		...
		public static void Spawn<T>(T obj, NetworkConnection ownerConnection = null) where T : Component
		{
			SpawnObject(obj.gameObject, ownerConnection);
		}
		...
		{
			DestroyObject(obj.gameObject, true);
		}
		...
		public static NetworkWriter GetEntitySerializationForConnection(NetworkIdentity identity, NetworkConnectionToClient connection)
		{
			// get serialization for this entity (cached)
			// IMPORTANT: int tick avoids floating point inaccuracy over days/weeks
			var serialization = identity.GetSerializationAtTick(Time.frameCount);
...
#pragma warning restore 618
		...
		public static readonly List<NetworkConnectionToClient> connectionsCopy = new List<NetworkConnectionToClient>();
