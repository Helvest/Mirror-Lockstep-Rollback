...
namespace Mirror
{
		...
		where T : NetworkBehaviour
	{
		...
		{
			return new SyncVarNetworkBehaviour<T>(value);
		}
		...
		{
			return obj is SyncVarNetworkBehaviour<T> value && this == value;
		}
		...
		private static T ULongToNetworkBehaviour(ulong value)
		{
		...
		private static ulong NetworkBehaviourToULong(T value)
		{
