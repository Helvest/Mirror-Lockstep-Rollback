...
namespace Mirror
{
	...
	public abstract class NetworkConnection
	{
		...
		internal readonly HashSet<NetworkIdentity> newObserving = new HashSet<NetworkIdentity>();
		...
		protected Batcher GetBatchForChannelId(int channelId)
		{
			...
			if (!batches.TryGetValue(channelId, out var batch))
			{
