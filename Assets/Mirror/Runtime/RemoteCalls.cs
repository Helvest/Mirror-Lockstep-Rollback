...
function == invokeFunction;
	...
	public static class RemoteProcedureCalls
	{
		...
		private static readonly Dictionary<int, Invoker> remoteCallDelegates = new Dictionary<int, Invoker>();

		private static bool CheckIfDelegateExists(Type componentType, RemoteCallType remoteCallType, RemoteCallDelegate func, int functionHash)
		{
		...
		private static bool GetInvokerForHash(int functionHash, RemoteCallType remoteCallType, out Invoker invoker)
		{
