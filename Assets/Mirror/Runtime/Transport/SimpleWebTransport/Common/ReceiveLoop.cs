...
namespace Mirror.SimpleWeb
{
	internal static class ReceiveLoop
	{
		...
		{
			(var conn, int maxMessageSize, bool expectMask, var queue, var _) = config;
		...
		{
			(var conn, int maxMessageSize, bool expectMask, var queue, var bufferPool) = config;
		...
		{
			(var conn, int _, bool expectMask, var queue, var bufferPool) = config;
		...
		{
			(var conn, int _, bool expectMask, var _, var _) = config;
