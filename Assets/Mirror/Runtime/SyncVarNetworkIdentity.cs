...
namespace Mirror
{
	...
	public class SyncVarNetworkIdentity : SyncVar<uint>
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static implicit operator NetworkIdentity(SyncVarNetworkIdentity field)
		{
			return field.Value;
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static implicit operator SyncVarNetworkIdentity(NetworkIdentity value)
		{
			return new SyncVarNetworkIdentity(value);
		}
		...
		{
			return obj is SyncVarNetworkIdentity value && this == value;
		}
