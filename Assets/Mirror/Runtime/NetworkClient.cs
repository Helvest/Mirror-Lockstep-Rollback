	...
	public static class NetworkClient
	{
		...
		internal static void RegisterSystemHandlers(bool hostMode)
		{
			...
			else
			{
				...
				RegisterHandler<SpawnMessage>(Rollback.OnSpawn);
				RegisterHandler<ObjectSpawnStartedMessage>(OnObjectSpawnStarted);
				RegisterHandler<ObjectSpawnFinishedMessage>(OnObjectSpawnFinished);
				RegisterHandler<EntityStateMessage>(Rollback.OnEntityStateMessage);
			}
		...
		internal static void OnTransportData(ArraySegment<byte> data, int channelId)
		{
			if (connection != null)
			{
				...
				while (!isLoadingScene &&
					   unbatcher.GetNextMessage(out var reader, out double remoteTimestamp))
				{
		...
		public static NetworkIdentity SpawnSceneObject(SpawnMessage message)
		{
