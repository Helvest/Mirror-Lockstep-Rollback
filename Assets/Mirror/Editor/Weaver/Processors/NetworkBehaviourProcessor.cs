...
namespace Mirror.Weaver
{
	...
	internal class NetworkBehaviourProcessor
	{
        ...
        */
		private void GenerateRegisterRemoteDelegate(ILProcessor worker, MethodReference registerMethod, MethodDefinition func, string cmdName)
		{
		...
		private void GenerateSerialization()
		{
			...
			var baseSerialize = Resolvers.TryResolveMethodInParents(netBehaviourSubclass.BaseType, Weaver.CurrentAssembly, SerializeMethodName);
		...
		private void DeserializeNetworkIdentityField(FieldDefinition syncVar, ILProcessor worker, MethodDefinition deserialize, MethodDefinition hookMethod)
		{
			/*
            Generates code like:
		...
		/// <param name="initialState"></param>
		/// <param name="hookResult"></param>
		private void DeserializeNetworkBehaviourField(FieldDefinition syncVar, ILProcessor worker, MethodDefinition deserialize, MethodDefinition hookMethod)
		{
			/*
            Generates code like:
		...
		/// <param name="initialState"></param>
		/// <param name="hookResult"></param>
		private void DeserializeNormalField(FieldDefinition syncVar, ILProcessor serWorker, MethodDefinition deserialize, MethodDefinition hookMethod)
		{
			/*
             Generates code like:
                // for hook
		...
		private void GenerateDeSerialization()
		{
			...
			var baseDeserialize = Resolvers.TryResolveMethodInParents(netBehaviourSubclass.BaseType, Weaver.CurrentAssembly, DeserializeMethodName);
		...
		private static bool ValidateParameter(MethodReference method, ParameterDefinition param, RemoteCallType callType, bool firstParam)
		{
