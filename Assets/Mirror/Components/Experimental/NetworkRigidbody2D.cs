...
namespace Mirror.Experimental
{
	...
	public class NetworkRigidbody2D : NetworkBehaviour
	{
		...
		[SerializeField] private bool clearVelocity = false;

		[Tooltip("Only Syncs Value if distance between previous and current is great than sensitivity")]
		[SerializeField] private float velocitySensitivity = 0.1f;
		...
		[SerializeField] private bool clearAngularVelocity = false;

		[Tooltip("Only Syncs Value if distance between previous and current is great than sensitivity")]
		[SerializeField] private float angularVelocitySensitivity = 0.1f;
