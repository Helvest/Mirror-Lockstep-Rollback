...
public class DebugLogTime : MonoBehaviour
{
	...
	private float fixedTimeCounter = 0f;

	private float preFixedTimeCounter = 0f;
	...
	private float timeByDelta = 0f;

	private float correctTime = 0f;
	private float correctDeltatime = 0f;

	private float predicTime = 0f;
	private float predictDeltatime = 0f;
