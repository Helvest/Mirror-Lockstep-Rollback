...
namespace HFSM
{
	...
	{
		private readonly Action<HybridStateMachine<TOwnId, TStateId, TEvent>> onEnter;
		private readonly Action<HybridStateMachine<TOwnId, TStateId, TEvent>> onLogic;
		private readonly Action<HybridStateMachine<TOwnId, TStateId, TEvent>> onExit;
		...
		public HybridStateMachine(
				...
				Action<HybridStateMachine<TOwnId, TStateId, TEvent>> onExit = null) : base()
		{
